        ...
        #[cfg(all(target_arch = "x86_64", target_os = "windows", target_env = "msvc"))]
        {
            ...
            (
                ...
                BurnPairNumericalWitnessV1 {
                    train_state_sha256: [
                        55, 212, 85, 76, 98, 50, 182, 141, 225, 231, 66, 98, 154, 58, 94, 178,
                        108, 164, 50, 190, 62, 32, 102, 182, 143, 237, 199, 75, 14, 178, 180,
                        35,
                    ],
                    model_digest_after:
    ...
    fn real_burn_pair_updates_once_and_is_topology_invariant() {
        ...
        assert_eq!(
            narrow_evidence.episodes[0]
                ...
                .trajectory_sha256(),
            [
                206, 204, 202, 83, 211, 229, 60, 79, 178, 67, 28, 33, 251, 247, 221, 162, 116,
                116, 169, 215, 228, 160, 65, 144, 30, 135, 83, 123, 92, 60, 227, 185,
            ]
        );
        // Re-baselined once per the owner ruling on record (collab CLAUDE
        ...
        assert_eq!(
            narrow_evidence.episodes[1]
                ...
                .trajectory_sha256(),
            [
                162, 131, 253, 244, 77, 73, 235, 205, 77, 158, 173, 180, 1, 20, 164, 57, 130,
                181, 15, 208, 117, 142, 3, 104, 207, 50, 221, 194, 231, 238, 51, 94,
            ]
        );
