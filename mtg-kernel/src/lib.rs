...
// Offline-only perfect-information rollout-teacher ceiling diagnostic. It
// publishes no model and its labels are not admissible for training.
pub mod native_rollout_teacher_v1;
