#!/usr/bin/env python3
"""Build and bind the sole CPU lib-test executable for admission v1."""
...
def build(
    *,
    ...
    executable = contract.resolve_lib_test_executable(_cargo_messages(cargo_stdout)).resolve()
...
if __name__ == "__main__":
    try:
        ...
        print(f"ACTION_INGRESS_BUILD_INVALID: {error}", file=sys.stderr)
        raise
