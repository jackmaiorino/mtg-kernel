...
fn live_actuator_is_isolated_authorization_bound_and_postcondition_locked() {
    ...
    for required in [
        ...
        "exact_owner_reviewed_existing_account_resource_entry_requires_fresh_recapture_and_visible_postcondition",
        ...
        "source_primitive_freshly_rechecked_unattested_targets_no_input",
    ...
    for required in [
        ...
        "fresh_entry_review_event_terms_and_enabled_control_exact_no_input_no_entry_no_spending",
