...
pub struct MtgoCompetitiveKnownWiringGapsV1 {
    ...
    pub direct_source_two_local_client_target_binding_harness_present: bool,
    pub direct_source_seated_duel_review_finalizer_present: bool,
    ...
    pub pre_entry_visible_deck_chooser_reviewed_two_state_corpus_present: bool,
...
pub fn check_competitive_wiring_static_readiness_v1() -> MtgoCompetitiveWiringStaticReadinessV1 {
    MtgoCompetitiveWiringStaticReadinessV1 {
        ...
        known_wiring_gaps: MtgoCompetitiveKnownWiringGapsV1 {
            ...
            direct_source_two_local_client_target_binding_harness_present: true,
            direct_source_seated_duel_review_finalizer_present: true,
...
mod tests {
    ...
    fn current_report_names_both_modes_and_grants_no_authority() {
        ...
        assert!(
            report
                .known_wiring_gaps
                .direct_source_managed_producer_root_seam_present
        );
        assert!(
            report
                .known_wiring_gaps
                .direct_source_synthetic_loader_qualification_present
        );
        assert!(
            report
                .known_wiring_gaps
                .direct_source_identity_pinned_live_abstention_broker_present
        );
        assert!(
            report
                .known_wiring_gaps
        ...
        assert!(
            report
                .known_wiring_gaps
                .direct_source_background_live_stable_abstention_passed
        );
        assert!(
            report
                .known_wiring_gaps
        ...
        assert!(
            report
                .known_wiring_gaps
                .direct_source_two_local_client_target_binding_harness_present
        );
        assert!(
            report
                .known_wiring_gaps
                .direct_source_seated_duel_review_finalizer_present
        );
        assert!(
            !report
                .known_wiring_gaps
        ...
        assert!(
            report
                .known_wiring_gaps
                .post_entry_operator_player_visible_target_ownership_present
        );
        assert!(
            report
                .known_wiring_gaps
                .post_entry_operator_player_visible_preinput_refresh_present
        );
        assert!(
            report
                .known_wiring_gaps
        ...
        assert!(
            report
                .known_wiring_gaps
                .pre_entry_exact_visible_deck_label_target_present
        );
        assert!(
            report
                .known_wiring_gaps
        ...
        assert!(
            report
                .known_wiring_gaps
                .pre_entry_visible_deck_chooser_classifier_protocol_present
        );
        assert!(
            report
                .known_wiring_gaps
                .pre_entry_visible_deck_chooser_reviewed_two_state_corpus_present
        );
        assert!(
            report
                .known_wiring_gaps
        ...
        assert!(
            report
                .known_wiring_gaps
                .visible_accessibility_catalog_corpus_evaluation_contract_present
        );
        assert!(
            !report
                .known_wiring_gaps
