...
#[cfg(target_os = "windows")]
pub use probe::{
    build_card_aware_bottoming_scoring_request_v5, build_card_aware_pregame_scoring_request_v4,
    build_pregame_action_plan_v3, build_pregame_scoring_request_v3,
    capture_mtgo_dxgi_frame_candidate_v3, card_aware_bottoming_scoring_request_commitment_v5,
    ...
    OpaqueMtgoCardAwarePregameModelSelectionV4, OpaqueMtgoConfirmedKeepToBottomSixTransitionV3,
