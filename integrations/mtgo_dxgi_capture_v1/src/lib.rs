...
pub use probe::{
    ...
    OpaqueMtgoAdmittedDuelVisibleFrameV1, OpaqueMtgoAttestedDirectVisibleSourceObservationV1,
    ...
    OpaqueMtgoClassifiedCompetitiveDeckChooserV1, OpaqueMtgoClassifiedCompetitiveDeckGateV1,
