...
pub use probe::{
    ...
    OpaqueMtgoCompetitiveLifecycleControlV1, OpaqueMtgoConfirmedBottomingSubmitV5,
    ...
    OpaqueMtgoProfileBoundDuelResolvedControlV1, OpaqueMtgoSourceBoundCompetitiveEventRecordV1,
