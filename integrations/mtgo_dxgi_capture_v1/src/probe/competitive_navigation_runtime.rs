...
pub(super) fn invoke_verified_competitive_deck_gate_classifier_process_v1(
    runtime: &OpaqueMtgoVerifiedCompetitiveNavigationClassifierRuntimeV1,
    header_json: &[u8],
    classifier_assets_manifest: &[u8],
    canonical_bgra8: &[u8],
    ...
    invoke_verified_classifier_process_v1(
        ...
        b"MTGO_VISIBLE_COMPETITIVE_DECK_GATE_V1\0",
        header_json,
        classifier_assets_manifest,
        canonical_bgra8,
        timeout,
...
pub(super) fn invoke_verified_competitive_deck_chooser_classifier_process_v1(
    runtime: &OpaqueMtgoVerifiedCompetitiveNavigationClassifierRuntimeV1,
    header_json: &[u8],
    classifier_assets_manifest: &[u8],
    canonical_bgra8: &[u8],
    ...
    invoke_verified_classifier_process_v1(
        ...
        b"MTGO_VISIBLE_COMPETITIVE_DECK_CHOOSER_V1\0",
        header_json,
        classifier_assets_manifest,
        canonical_bgra8,
        timeout,
