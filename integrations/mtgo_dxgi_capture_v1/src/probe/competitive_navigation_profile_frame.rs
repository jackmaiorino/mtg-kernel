...
/// bound to one separately admitted 18-slice lifecycle profile. This telemetry does
...
/// binds the opaque result to one separately admitted 18-slice lifecycle
...
pub fn capture_admitted_mtgo_competitive_navigation_frame_v1(
    ...
    {
        return Err(
            "navigation profile does not cover all nine League and Challenge lifecycle phases"
                .to_owned(),
        );
    }
