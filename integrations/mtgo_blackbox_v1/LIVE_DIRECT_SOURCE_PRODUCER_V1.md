...
game state remains incomplete. Version 1.14 includes the 74-getter visible
...
Version 1.14 reads those private transformation values only as one-way guards
...
player-visible modal is represented.
