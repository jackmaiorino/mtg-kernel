...
# Frozen by mtg-kernel/src/card_def.rs::card_db_hash_v17_is_frozen and checked
# again by the Rust production-commitment golden test.
KERNEL_CARDDB_HASH = 0xA2EB_E984_FE6F_33BE
...
def _action_commitment_goldens(action_contract: dict[str, Any], card_db_hash: int) -> dict[str, object]:
    ...
    return {
        ...
        "card_db_hash_authority": {
            "source": "mtg-kernel/src/card_def.rs::card_db_hash_v17_is_frozen",
