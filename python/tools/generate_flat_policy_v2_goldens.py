...
# Frozen by mtg-kernel/src/card_def.rs::card_db_hash_v21_is_frozen and checked
# again by the Rust production-commitment golden test.
KERNEL_CARDDB_HASH = 0xBFE2_C254_4934_26F1
...
def _action_commitment_goldens(action_contract: dict[str, Any], card_db_hash: int) -> dict[str, object]:
    ...
    return {
        ...
        "card_db_hash_authority": {
            "source": "mtg-kernel/src/card_def.rs::card_db_hash_v21_is_frozen",
