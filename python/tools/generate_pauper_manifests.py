...
EXPECTED_MAINBOARD_SUPPORT = {
    ...
    "Spy": {"full": 55, "partial": 0, "no_effect": 5},
...
def normalize_registry(
    ...
    if non_token_count != 146 or token_names != expected_token_names:
        raise ManifestError(
            f"registry baseline drift: expected 146 deck cards and tokens "
