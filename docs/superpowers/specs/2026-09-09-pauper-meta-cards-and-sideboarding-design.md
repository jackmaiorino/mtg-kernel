...
6. Any schema migration required by any wave receives an owner ruling before landing or deployment; W7 additionally requires the oracle and toolchain upgrade of the Mage fork with a CP7 baseline requalification.
